...
class ToReceiveFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_to_receive, container, false)
        ...
        srlOrder = root.findViewById(R.id.srl_toreceive_order_id)

        initRecyclerView()
        initViewModel()

        val member_id = memberDetailsSp.getValueString(getString(R.string.spKeyId))
        ordersViewModel.getOrders(member_id!!,3)
